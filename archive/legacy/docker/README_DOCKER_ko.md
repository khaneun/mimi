...
Cron 작업 출력은 `/app/market-pulse/logs/`에 저장됩니다:
...
| 컨테이너 접속 | 🖥️ 호스트/로컬 | `docker-compose exec market-pulse /bin/bash` |
...
- **프로젝트**: https://github.com/jacob119/market-pulse
- **텔레그램**: https://t.me/stock_ai_agent
- **이슈**: https://github.com/jacob119/market-pulse/issues
...
- **로컬 환경**: `~/my-path/market-pulse` ✅
- **Docker 환경**: `/app/market-pulse` ✅
