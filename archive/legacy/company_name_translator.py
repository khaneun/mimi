...
# The translate_company_name() function uses mcp-agent Agent/LLM classes that are no longer available.
# Retained for reference only. Helper functions (_romanize_korean_name, _sanitize_for_filename) are
# still usable as standalone utilities.
#
# Previously imported (inside translate_company_name):
